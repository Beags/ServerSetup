...
mysql -u root -p -e 'GRANT ALL ON wordpress.* TO 'wordpress'@'localhost';'
mysql -u root -p -e 'USE wordpress update * set password=PASSWORD('$Passwordvar') where User='wordpress';'
cd /var/www/html
...
define('DB_PASSWORD', '$Passwordvar');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '$Firstsecretvar');
define('SECURE_AUTH_KEY',  '$Secondsecretvar');
define('LOGGED_IN_KEY',    '$thirdsecretvar');
define('NONCE_KEY',        '$Fourthsecretvar');
define('AUTH_SALT',        '$Fifthsecretvar');
define('SECURE_AUTH_SALT', '$Sixthsecretvar');
define('LOGGED_IN_SALT',   '$Seventhsecretvar');
define('NONCE_SALT',       '$Eighthecretvar');
